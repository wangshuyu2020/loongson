...
class face_rec():
    ...
    def recognize(self, draw, cap):
        ...
        for (left, top, right, bottom), name in zip(rectangles, face_names):
            ...
            cv2.putText(draw, '{0:.2f}'.format(random.uniform(35.92, 36.8)), (left, top - 15), font, 0.75, (0,255,0),
                            2)
...
#         dududu.recognize(draw,video_capture)
